...
public class TC4Interop{
	...
	private static void initTCAspects(){
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemEssence.META_NIGHTMARE), new AspectList().add(Aspect.VOID, 3).add(Aspect.ENTROPY, 3).add(Aspect.AURA, 3));
