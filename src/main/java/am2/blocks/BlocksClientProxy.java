...
public class BlocksClientProxy extends BlocksCommonProxy{
	...
	public static TileEntitySpatialVortex spatialVortexInventoryRenderer;
	...
	public BlocksClientProxy(){
		...
		spatialVortexInventoryRenderer = new TileEntitySpatialVortex();
	...
	public void registerRenderInformation(){
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityManaSources.class, new EssenceGeneratorRenderer());
