...
public class TileEntityInertSpawner extends TileEntityManaConsumer implements IInventory, ISidedInventory {
	...
	public ItemStack getStackInSlot(int slot) {
		if (slot < getSizeInventory() && phylactery != null) {
			return phylactery;
		}
	...
	public boolean isItemValidForSlot(int slot, ItemStack stack) {
		return slot == 0 && stack != null && stack.getItem() instanceof ItemCrystalPhylactery;
	}
	...
	@Override
	public boolean canInsertItem(int slot, ItemStack stack, int face) {
